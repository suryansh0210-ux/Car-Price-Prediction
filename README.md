...
3. The model uses Linear Regression to learn the relation between car features and price.  
4. It tests the model on unseen data to measure accuracy (~95%).  
5. Finally, it predicts the price of a new car (e.g., 4 years old, 22 km/l mileage).
...
- How to compare actual vs predicted results  
